...
(
        batchId BIGINT,
        disk_used BIGINT,
        durationMs STRUCT < addBatch: BIGINT,
        getBatch: BIGINT,
        latestOffset: BIGINT,
        queryPlanning: BIGINT,
        triggerExecution: BIGINT,
        walCommit: BIGINT >,
        eventTime STRUCT < avg: STRING,
        max: STRING,
        min: STRING,
        watermark: STRING >,
        ...
        runId STRING,
        sink STRUCT < description: STRING,
        numOutputRows: BIGINT >,
        sources ARRAY < STRUCT < description: STRING,
        endOffset: BIGINT,
        inputRowsPerSecond: DOUBLE,
        latestOffset: BIGINT,
        numInputRows: BIGINT,
        processedRowsPerSecond: DOUBLE,
        startOffset: BIGINT > >,
        stateOperators ARRAY < STRUCT < allRemovalsTimeMs: BIGINT,
        allUpdatesTimeMs: BIGINT,
        commitTimeMs: BIGINT,
        customMetrics: STRUCT < updateTagCacheTimer: BIGINT,
        getTagCount: BIGINT,
        putTagCount: BIGINT,
        sortTimer: BIGINT,
